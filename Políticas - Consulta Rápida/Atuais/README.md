...
Esta pasta contém cópias de distribuição das políticas transversais atualmente aplicáveis.

Uso pretendido:

- consulta rápida;
- copiar policies para um novo projeto;
- entregar o conjunto atual a um agente;
- montar pacote inicial de governança.

IMPORTANTE:

Estas cópias NÃO são a source of truth.

Não editar policies nesta pasta.

Alterações devem ocorrer na fonte formal e depois ser sincronizadas.
...
A promoção continua ocorrendo na estrutura formal. Esta pasta apenas reflete o estado posterior.
...
A mesma versão física das três policies atuais também foi encontrada no pacote formal de continuidade, com os mesmos hashes. O mirror foi derivado do pacote formal de abertura de projeto; nenhum dos pacotes formais foi alterado.
