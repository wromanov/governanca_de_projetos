...
## Versão 1.1 — PROPOSTA CONTROLADA

```text
STATUS = PROPOSED
LIFECYCLE = DRAFT
BASELINE = Politica-de-Uso-de-Skills-Codex-Work-v1.0.md
SCOPE = TRANSVERSAL
...
A `Politica-Prompts-Agente-v1.4.md` permanece a authority vigente enquanto não houver nova canonicalização.

Esta v1.1 propõe um refinamento de ordem e semântica:
...
Ao canonicalizar esta política, a Política de Geração de Prompts deve ser sincronizada para eliminar divergência estrutural entre documentos.

```text
PROMPT_POLICY_SYNC_REQUIRED = YES
PROMPT_POLICY_v1.4_SYNC_REQUIRED = YES
PROMPT_POLICY_v1.5_SYNC_REQUIRED = YES
SYNC_ACTION_AUTHORIZED = NO
...
- `Politica-de-Uso-de-Skills-Codex-Work-v1.0.md`;
- `Politica-Prompts-Agente-v1.4.md`;
...
**Baseline preservada:** v1.0  
**Canonicalização:** NÃO executada  
**Revisão do usuário:** obrigatória antes de promoção.
