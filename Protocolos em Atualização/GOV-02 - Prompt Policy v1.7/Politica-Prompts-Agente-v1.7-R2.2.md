# Política de Geração de Prompts Multiagente — v1.7-R2.2

```text
STATUS = PROPOSED_REVISION
LIFECYCLE = REVIEW_CANDIDATE
PREVIOUS_BASE = Politica-Prompts-Agente-v1.7-R2.1.md
CONSOLIDATES = Politica-Prompts-Agente-v1.7-R2.1.md
REVISION_FOCUS = ROOT_SELECTION_HARDENING
...
39. Se o ganho de Sol/Astra for incerto, usar o menor modelo suficiente.
...
VERSION = v1.7-R2.2
STATUS = PROPOSED_REVISION
PREVIOUS_VERSION = v1.7-R2.1
REVISION_TYPE = ROOT_SELECTION_HARDENING
