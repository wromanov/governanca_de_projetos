# Política de Geração de Prompts Multiagente — v1.7-R2.1

```text
STATUS = PROPOSED_REVISION
LIFECYCLE = REVIEW_CANDIDATE
PREVIOUS_BASE = Politica-Prompts-Agente-v1.7-R2.md
CONSOLIDATES = Politica-Prompts-Agente-v1.7-R2.md
REVISION_FOCUS = ANTI_OVERDELEGATION + PROMPT_COMPRESSION_HARDENING
...
32. Se o ganho de Sol/Astra for incerto, usar o menor modelo suficiente.
...
VERSION = v1.7-R2.1
STATUS = PROPOSED_REVISION
PREVIOUS_VERSION = v1.7-R2
REVISION_TYPE = HARDENING
...
ANTI_OVERDELEGATION_HARDENING = INCLUDED
